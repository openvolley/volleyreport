...
if (isTRUE(vsx$plot_summary) || isTRUE(vsx$plot_markers)) showtext::showtext_opts(dpi = 175 * 2.2) ## not sure why this multiplier is needed
...
volleyreport:::vr_content_key(vsx, kable_format, cols = if (beach) 14 else 2)
cat("</td>\n")
cat("</tr></table>\n</div>\n")
```
