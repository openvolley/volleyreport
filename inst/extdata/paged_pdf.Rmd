...
```{r mr_score_evb, warning = FALSE, eval = vsx$style %in% c("ov1") & beach, results = "asis", fig.height = 60 / 25.4, fig.width = 210 / 25.4}
p <- volleyreport:::vr_content_score_evplot(vsx)
if (!is.null(p)) {
    #cat("\n<div style=\"margin-top:-5mm; margin-bottom:-2mm;\">\n")
    print(p)
...
cat0("</td><td width=\"", if (beach) 60 else 21.7, "%\">\n")
volleyreport:::vr_content_key(vsx, kable_format, cols = if (beach) 6 else 2)
cat("</td>\n")
cat("</tr></table>\n</div>\n")
```
