...
[![R build status](https://github.com/openvolley/volleyreport/workflows/check-standard/badge.svg)](https://github.com/openvolley/volleyreport/actions)
<!-- badges: end -->
...
library(volleyreport)
x <- dv_read(dv_example_file())
rpt <- vr_match_summary(x, format = "png", outfile = "man/figures/README-example.png")
```
