...
[![R-CMD-check](https://github.com/openvolley/volleyreport/workflows/R-CMD-check/badge.svg)](https://github.com/openvolley/volleyreport/actions)
[![R-CMD-check](https://github.com/openvolley/volleyreport/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/openvolley/volleyreport/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->

The volleyreport package provides functions for generating reports from
